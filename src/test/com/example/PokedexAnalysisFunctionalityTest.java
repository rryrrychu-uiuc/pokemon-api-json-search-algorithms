...
public class PokedexAnalysisFunctionalityTest {
    ...
    public void testValidAvgStat() {
        ...
        Double actualAverage = Pokedex.averageBaseStatValueOfSpecificType(original151Dex, "water", "attack");
    ...
    public void testValidSortWithMove() {
        ...
        Pokedex actualPkmn = Pokedex.sortPokemonByStatGivenMove(original151Dex, "speed", "transform", true);
        assertArrayEquals(expectedPkmn, Pokedex.getPokemonNames(actualPkmn).toArray());
    }
    ...
    public void testValidSortWithMoveReverse() {
        ...
        Pokedex actualPkmn = Pokedex.sortPokemonByStatGivenMove(original151Dex, "speed", "transform", false);
        assertArrayEquals(expectedPkmn, Pokedex.getPokemonNames(actualPkmn).toArray());
    }
